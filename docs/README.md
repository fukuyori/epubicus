...
This directory keeps operator-facing guides separate from design notes.
...
- [multilingual-design.md](multilingual-design.md) - Design notes for future multilingual support and target-aware validation.

## Root Documents

- [../README.md](../README.md) - English quick start and command reference.
- [../README.ja.md](../README.ja.md) - Japanese quick start and command reference.
