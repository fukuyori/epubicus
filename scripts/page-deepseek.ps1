# Run a trial DeepSeek translation for a selected content-file range.
#
# Usage:
#   .\scripts\page-deepseek.ps1 .\book.epub 9 9
#   .\scripts\page-deepseek.ps1 .\book.epub 9 9 -NoRun
#
# Arguments:
#   1: input EPUB path.
...
if ($From -le 0 -or $To -le 0) {
    throw "Start and end spine numbers are required. Run .\scripts\inspect-epub.ps1 first, then pass a range such as: .\scripts\page-deepseek.ps1 .\book.epub 5 5"
}
...
& $envScript -InputPath $InputPath -From $From -To $To -NoRun:$NoRun
