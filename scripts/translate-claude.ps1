...
#     .\scripts\translate-claude.ps1 .\test\sample.epub
#
#   Page-range test:
#     .\scripts\translate-claude.ps1 .\test\sample.epub -From 3 -To 3
#
#   Usage estimate only (no API call):
#     .\scripts\translate-claude.ps1 .\test\sample.epub -From 3 -To 3 -UsageOnly
#
#   Rebuild from cache without calling the provider:
#     .\scripts\translate-claude.ps1 .\test\sample.epub -PartialFromCache
#
#   Kindle fixed-layout output (force or suppress):
#     .\scripts\translate-claude.ps1 .\test\sample.epub -KindleFixedLayout
#     .\scripts\translate-claude.ps1 .\test\sample.epub -NoKindleFixedLayout
#
#   Pass additional epubicus translate options:
#     .\scripts\translate-claude.ps1 .\test\sample.epub --glossary .\glossary.json
#
#   Or load it without running:
#     . .\scripts\translate-claude.ps1 .\test\sample.epub -NoRun
#     Invoke-EpubicusTranslate
#
#   Use Cargo dev profile for script/debug checks:
#     .\scripts\translate-claude.ps1 .\test\sample.epub -DevBuild -NoRun
